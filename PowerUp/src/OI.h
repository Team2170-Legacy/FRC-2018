...
private:
	...
	std::shared_ptr<frc::JoystickButton> joystickButtonBack;
	std::shared_ptr<frc::JoystickButton> joystickButtonStart;
	std::shared_ptr<frc::JoystickButton> joystickButtonRightClick;
