...
static std::shared_ptr<frc::SpeedController> RobotMap::climberMotor;
...
void RobotMap::init() {
    ...
    climberDoubleSolenoid.reset(new frc::DoubleSolenoid(20, 2, 3));
    climberMotor.reset(new frc::Spark(2));
}
