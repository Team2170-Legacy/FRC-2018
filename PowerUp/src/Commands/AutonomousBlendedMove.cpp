...
AutonomousBlendedMove::AutonomousBlendedMove() {
...
AutonomousBlendedMove::AutonomousBlendedMove(const ProfileData* Left, const ProfileData* Right, double time, int* error) {
