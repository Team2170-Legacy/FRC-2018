...
Arm::Arm() : frc::Subsystem("Arm"),
	...
	talonSRXArmMotor->ConfigPeakCurrentDuration(OCTime, 10);
	talonSRXArmMotor->ConfigContinuousCurrentLimit(CurrentFoldback, 10);
	talonSRXArmMotor->EnableCurrentLimit(bCurrentLimit);
