...
void DriveTrain::InitMotors() {
	...
	talonSRXSlaveLeft1->Set(ControlMode::Follower, 0.0);
	talonSRXSlaveLeft2->Set(ControlMode::Follower, 0.0);
	talonSRXSlaveRight1->Set(ControlMode::Follower, 0.0);
	talonSRXSlaveRight2->Set(ControlMode::Follower, 0.0);
