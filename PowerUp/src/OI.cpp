...
OI::OI() {
    ...
    joystickButtonBumperLeft->WhenPressed(new IntakeToggle());
    ...
    joystickButtonBack.reset(new frc::JoystickButton(joystickOperator.get(), 7));
    joystickButtonBack->WhenPressed(new ScissorToggle());
    joystickButtonStart.reset(new frc::JoystickButton(joystickOperator.get(), 8));
    joystickButtonStart->WhileHeld(new ClimbDownWhileHeld());
}
