...
public:
	...
	static std::shared_ptr<WPI_TalonSRX> driveTrainTalonSRXMasterLeft;
	static std::shared_ptr<WPI_TalonSRX> driveTrainTalonSRXMasterRight;
	static std::shared_ptr<frc::DifferentialDrive> driveTrainDifferentialDrive1;
	static std::shared_ptr<WPI_TalonSRX> driveTrainTalonSRXSlaveLeft1;
	...
	static std::shared_ptr<WPI_TalonSRX> armTalonSRXArmMotor;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	static std::shared_ptr<frc::DoubleSolenoid> climberDoubleSolenoid;
